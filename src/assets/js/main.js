...
jQuery(document).on('ready', function() {
	"use strict";
	jQuery('.themetabnav > li > a').hover(function() {
		jQuery(this).tab('show');
	});
	/*--------------------------------------
			SCROLL TO TOP					
	--------------------------------------*/
	var _tg_btnscrolltop = jQuery("#allbutton-btnbacktotop");
	...
	/*--------------------------------------
			HOME SLIDER						
	--------------------------------------*/
	var _tg_homeslider = jQuery('#homeslider');
	_tg_homeslider.owlCarousel({
		...
		navClass: [
					'owl-prev allbutton-btnround allbutton-btnprev',
					'owl-next allbutton-btnround allbutton-btnnext'
				],
	});
	/*--------------------------------------
			BEST BOOK SLIDER				
	--------------------------------------*/
	var _tg_bestsellingbooksslider = jQuery('#peopleChoice');
	...
	-------------------------------------- */
	try {
		var _tg_collectioncounters = jQuery('#collectioncounters');
		_tg_collectioncounters.appear(function () {
			
			var _tg_collectioncounter = jQuery('.collectioncounter h3');
	...
	--------------------------------------*/
	var _tg_pickedbyauthorslider = jQuery('#pickedbyauthorslider');
	...
	/*--------------------------------------
			PICKED BY AUTHOR SLIDER			
	--------------------------------------*/
	var _tg_authorsslider = jQuery('#authorsslider');
